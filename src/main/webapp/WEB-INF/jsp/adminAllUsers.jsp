...
<div class="wrapper">
    ...
    <table width="100%">
        <tr>
            <td><fmt:message key="table.UserID"/></td>
            <td><fmt:message key="table.UserLogin"/></td>
            <td><fmt:message key="table.UserStatus"/></td>
            <td><fmt:message key="table.UserMail"/></td>
            <td><fmt:message key="table.BlockUser"/></td>
